...
const Loading = () => {
  ...
  if (!mounted) {
    return (
      <div className="flex flex-col items-center justify-center app_height" suppressHydrationWarning>
        <div className="mb-3">
          <img src={Logo} alt="Logo" />
        </div>
        <svg
          className="animate-spin ltr:-ml-1 ltr:mr-3 rtl:-mr-1 rtl:ml-3 h-12 w-12"
