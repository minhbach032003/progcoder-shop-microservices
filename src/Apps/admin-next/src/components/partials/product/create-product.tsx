  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        submitFormData.append("price", String(values.price));
        submitFormData.append("salePrice", String(values.salePrice || 0));
        submitFormData.append("published", String(published));
        submitFormData.append("featured", String(featured));
        ...
        submitFormData.append("weight", String(values.weight || 0));
